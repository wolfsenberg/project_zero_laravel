<x-layout>
    <div class ="bg-gray-50 border border-gray-200 rounded p-6  max-w-xl mx-auto mt-24"> 
        ...
        <form method="POST" action="/users/authenticate">
            ...
            <div class="mb-6">
                <button type="submit" class="bg-blue-500 text-white rounded-full py-2 px-4 hover:bg-black">
                    Sign In
                </button>
            </div>
