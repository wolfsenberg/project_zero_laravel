...
<head>
    ...
    <link rel="icon" href="{{ asset('images/project_zero_logo.png') }}" type="image/png" />
...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="/" class="pl-4 flex items-center">
            <img class="w-24" src="{{ asset('images/project_zero_logo.png') }}" alt="Logo" />
            <span class="ml-5 text-2xl font-bold text-blue-500">PROJECT ZERO</span>
        </a>
        <ul class="flex space-x-6 mr-6 text-lg">
            ...
            <li>
                <a href="/listings/manage" class="hover:text-blue-500"><i class="fa-solid fa-gear"></i>
                    Manage Listings</a>
            </li>
            <li>
